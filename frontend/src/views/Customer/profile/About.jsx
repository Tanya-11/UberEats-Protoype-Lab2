...
export const About = (props) => {
    ...
    const submitCustomerData = () => {
        ...
        const setProfile = Axios.post('http://18.224.59.255:3001/api/customer/profile/save', {
            ...userData,
            userId: customer,
        })
        const setPhoto = Axios.post('http://18.224.59.255:3001/api/upload/photo', formData, config)
    ...
    const submit = async (event) => {
        ...
        //  const result = await Axios.post('http://18.224.59.255:3001/upload-pic', formData, config)
        //  setImage(result.data.imagePath)
        //  setImage('image/3fe4ee4f70dfcfc6cf0fc7acb09ea0f5')
        //   const result = await Axios.get('http://18.224.59.255:3001/fetch-file')
        ...
        <div>
            {image && (
                <img
                    ...
                    src={`http://18.224.59.255:3001/api/images/${image}`}
                />
            )}
            <label>
                Name:
